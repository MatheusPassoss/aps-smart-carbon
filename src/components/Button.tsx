...
export const Button = ({ buttonRef, Title, leftIcon, RightIcon, Icon: Icon, ...rest }: ButtonProps) => {
  ...
  return (
    <button className="bg-green-custom py-1 px-3 w-full text-white rounded-lg md:text-lg flex justify-center items-center gap-2 transition-all hover:bg-green-custom-strong" {...rest} ref={buttonRef}>
